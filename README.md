About fs-s3fs-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fs-s3fs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3886&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fs-s3fs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fs-s3fs` can be installed with `conda`:
...
```
mamba install fs-s3fs
```

It is possible to list all of the versions of `fs-s3fs` available on your platform with `conda`:
...
```
mamba search fs-s3fs --channel conda-forge
```
...
mamba repoquery search fs-s3fs --channel conda-forge

# List packages depending on `fs-s3fs`:
mamba repoquery whoneeds fs-s3fs --channel conda-forge

# List dependencies of `fs-s3fs`:
mamba repoquery depends fs-s3fs --channel conda-forge
```
